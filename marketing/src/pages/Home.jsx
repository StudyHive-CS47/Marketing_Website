    ...
    <>
      ...
      <div className="relative min-h-screen w-full">
        ...
        <div className="w-full py-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto px-4 tracking-wide mb-8">
            For students, by students.
          </p>

          <div className="flex flex-col sm:flex-row gap-6">
            <StyledButton onClick={scrollToSocialMedia}>
              Connect with us
            </StyledButton>
            <StyledButton onClick={() => navigate('/learn-more')} variant="outline">
              Learn More
            </StyledButton>
          </div>
        </div>
